...
| **Gemini 3.1 Pro** | gemini-2.5-pro (via Google AI Studio) | Design brainstorming, user persona generation, medieval theme conceptualization, poster content drafting, README writing |
